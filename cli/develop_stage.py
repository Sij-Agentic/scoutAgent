#!/usr/bin/env python3
"""
Development tool for ScoutAgent.

This script allows developing new agent stages using data from an existing run.
"""
...
logger = get_logger("develop_stage")
...
async def develop_stages(
    ...
    # Register existing agents that the development agent depends on
    try:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Develop agent stages")
